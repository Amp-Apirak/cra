...
<head>
    ...
    <div class="content-wrapper">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date">
                                                    <input type="text" value="<?php echo $date; ?>" name="km_date"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="int" name="km_type" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="int" name="km_subj" class="form-control"
                                                    id="exampleInputEmail1" placeholder="" required>
                                            </div>
                                            <!-- /.form-group -->
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="card card-outline card-info">
                                      ...
                                      <!-- /.card-header -->
                                      <div class="card-body">
                                        <textarea id="summernote" name="km_re"  >
        ...
        <div class="form-group">
            ...
            <input type="int" name="km_staff" class="form-control" id="exampleInputEmail1" placeholder="" required>
        </div>
        <!-- /.form-group -->
